...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s netcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  netcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded netcoin transaction") + "\n" +
              "  netcoin-tx [options] -create [commands]   " + _("Create hex-encoded netcoin transaction") + "\n" +
              "\n";
