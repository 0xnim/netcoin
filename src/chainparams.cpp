...
{
    const char* pszTimestamp = "THN 21/Oct/2023 Cisco Zero-Day Exploited to Implant Malicious Lua Backdoor on Thousands of Devices";
    const CScript genesisOutputScript = CScript() << ParseHex("240194710fa689ad5023690c80f3a49c8f13f8d45b8c857fbcbc8bc4a8e4d3eb4b10f4d4604fa08dce601aaf0f470216fe1b51850b4acf21b179c45070ac7b03a9") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1698019200, 2084651689, 0x1e0ffff0, 1, 18 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x00000cd7db399d3ffc6b807ce5653de4d3fce281389921f9def4102db6984223"));
        assert(genesis.hashMerkleRoot == uint256S("0x2525476d4449ed52de19df215d029dd417100a963702acd5ca99a46f05d81951"));

        // Note that of those with the service bits flag, most only support a subset of possible options
        vSeeds.push_back(CDNSSeedData("165.227.112.146", "165.227.112.146", true));
        /*vSeeds.push_back(CDNSSeedData("thrasher.io", "dnsseed.thrasher.io", true));
        vSeeds.push_back(CDNSSeedData("netcointools.com", "dnsseed.netcointools.com"));
        vSeeds.push_back(CDNSSeedData("netcoinpool.org", "dnsseed.netcoinpool.org"));
        ...
        */
        ...
        checkpointData = (CCheckpointData) {
            ...
            (  0, uint256S("0x00000cd7db399d3ffc6b807ce5653de4d3fce281389921f9def4102db6984223"))
        ...
        chainTxData = ChainTxData{
            ...
            1698019200, // * UNIX timestamp of last known number of transactions
...
public:
    CTestNetParams() {
        ...
        */
        ...
        vSeeds.push_back(CDNSSeedData("165.227.112.146", "165.227.112.146"));
        /*vSeeds.push_back(CDNSSeedData("loshan.co.uk", "seed-b.netcoin.loshan.co.uk", true));
