...
const char * const BITCOIN_CONF_FILENAME = "netcoin.conf";
const char * const BITCOIN_PID_FILENAME = "netcoin.pid";
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Netcoin";
#else
    // Unix
